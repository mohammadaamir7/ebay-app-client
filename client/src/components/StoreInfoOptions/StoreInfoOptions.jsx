...
const StoreInfoOptions = () => {
  ...
  const handleChange = (event) => {
    ...
    setDefaultQuantity(data?.Suppliers?.find(supplier => supplier?.name === event.target.value)?.defaultQuantity || 0)
    setQuantityAdjustment(data?.Suppliers?.find(supplier => supplier?.name === event.target.value)?.quantityAdjustment || 0)
  };
            ...
            >
              ...
              >
                <Grid container spacing={2}>
                  ...
                  <Button onClick={() => {}} sx={{ m: 3 }} variant="contained">
                    Format
                  </Button>
                </Grid>
              </Box>
      ...
      <div className="card shadow mb-3">
        <ThemeProvider theme={defaultTheme}>
          <Container component="main" maxWidth="md">
            ...
            >
              <div className="panel-table-search-btn">
                <div className="panel-search">
                  <Button variant="contained" onClick={handleSync} disabled={currentSupplier === ""}>
                    Sync Listings
                  </Button>
                </div>
              </div>
              ...
              >
                ...
                <Grid container spacing={2}>
                  ...
                  {currentSupplier && (
                    <>
                      <Grid item xs={6}>
                        <h5>Default Quantity and Offset</h5>
                        <TextField
                          fullWidth
                  ...
                  {inputFields.length > 0 && (
                    <Grid>
                      <h5 className="mt-5">Price range quantity</h5>
                  ...
                  {!isPriceRangeMarkUp && markUpFields.length > 0 && (
                    <Grid>
                      <h5 className="mt-5">Price range markUp</h5>
            ...
            <Button variant="contained" sx={{ mt: 3, mb: 3 }} onClick={saving}>
              Save
            </Button>
          </Container>
        </ThemeProvider>
